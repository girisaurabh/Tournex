...
function App() {
  ...
  const handleSendMessage = (e) => {
    ...
    setTimeout(() => {
      ...
      if (lower.includes('hi') || lower.includes('hello') || lower.includes('hey')) {
        ...
        reply = `Must-try local delicacy in ${activeDest.name}: ${activeDestination.food}!`;
  ...
  return (
    ...
    >
      ...
      {/* Main Container - Centered Glassmorphic Panel */}
      ...
      <div className="fixed bottom-6 right-6 z-40">
        {!isChatOpen ? (
          <button 
            ...
            className="bg-gradient-to-r from-emerald-400 to-teal-500 hover:from-emerald-300 hover:to-teal-400 text-slate-950 font-bold p-4 rounded-full shadow-2xl flex items-center gap-2 cursor-pointer transition transform hover:scale-105 border border-emerald-300/50 shadow-emerald-500/20"
          >
            <span className="text-xl">🤖</span>
